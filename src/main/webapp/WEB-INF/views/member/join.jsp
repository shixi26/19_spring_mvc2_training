...
<script src="http://dmaps.daum.net/map_js_init/postcode.v2.js"></script> <!-- dmap import -->
<script src="${contextPath}/resources/ckeditor/ckeditor.js"></script>  <!-- ckeditor에 있는거 가져옴(202줄) -->
<script>
